...
class GroupController extends Controller
{
    ...
    public function actionView($slug, $sort='rank')
    {
		...
		$update_group = false;
		if((strtotime($timestamp) - strtotime($model->last_visit)) > 86400){
        ...
        $dataProvider = new ArrayDataProvider([
			...
			'sort' => [
				...
				'attributes' => [
					'fullrank' => [
						'asc' => ['rank' => SORT_ASC, 'division' => SORT_DESC, 'lp' => SORT_ASC],
						'desc' => ['rank' => SORT_DESC, 'division' => SORT_ASC, 'lp' => SORT_DESC],
						'default' => SORT_DESC,
						'label' => 'Rank',
					], 
					'regionDesc',
