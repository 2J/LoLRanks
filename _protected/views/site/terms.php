...
These Terms of Service and our privacy policy (together the “Terms”) govern all use of LoL Ranks(http://lolranks.j2.io) and that site’s services (together the “Site” or “Services”). The Site is owned by Koggiri, an individual.
...
You are responsible for protecting your username and password for the Site, and you agree not to disclose it to any third party. We recommend that you use a password that is more than eight characters long. You are responsible for all activity on your account, whether or not you authorized it. You agree to inform us of unauthorized use of your account, by email to jj@j2.io. You acknowledge that if you wish to protect your interactions with the Site, it is your responsibility to use a secure encrypted connection, virtual private network, or other appropriate measures. The Site’s own security measures are reasonable in terms of their level of protection, but are not helpful if the interactions of you or any other User with Site are not secure or private.
<h2>Disputes</h2>
We are based in Windsor, ON and you are contracting to use our Site. These Terms and all matters arising from your use of the Site are governed by and will be construed according to the laws of Windsor, ON, without regard to any choice of laws rules of any jurisdiction. The federal courts and state courts that have geographical jurisdiction over disputes arising at our office location in the Windsor, ON will be the only permissible venues for any and all disputes arising out of or in connection with these Terms or the Site and Service.
<h3>ARBITRATION</h3>
Notwithstanding anything that may be contrary within the “Disputes” provisions above, all matters, and all arbitrable claims within a multi-claim matter, including all claims for monetary damages, shall be decided by a single arbitrator to be selected by us, which arbitrator shall hold hearings in or near Windsor, ON, under the rules of the American Arbitration Association.
<h2>Advertising</h2>
...
<h2>Terms Contact</h2>
If you have any questions about these Terms, please address them to jj@j2.io.
<h2>Last Updated</h2>
These terms were last updated on <em>2015-04-26</em>